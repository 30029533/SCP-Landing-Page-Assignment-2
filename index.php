            ...
            <ul class="nav navbar-dark bg-dark">
                <?php foreach($result as $menu_item): ?>
                    <li class="nav-item active">
                            <a class="nav-link-active text-light" href="index.php?subject='<?php echo $menu_item["item_no"];?>'">
                ...
                if(isset($_GET['subject'])){
                    ...
                    // If subject have an image
                        ...
                        if($reference == NULL){
                            ...
                            <h3> Object Class: {$Object_class} </h3>
                            <h3> Subject Image </h3>
                            <p> <img src='images/{$Subject_image}' class='img-fluid rounded mx-auto d-block img-responsive shadow p-3 mb-5 bg-white'> </p>
                            <h3> Procedures </h3>
                            <p> {$pro1} </p>
                            <h3> Description </h3>
                            <p> {$Description} </p>
